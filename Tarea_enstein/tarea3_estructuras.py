...
def main():
    ...
    # Para esta imagen grande (1,440,000 elementos), vamos a usar una muestra
    # para los algoritmos lentos, o podemos comentarlos
    print("\nNOTA: Debido al tamaño de la imagen (1,440,000 píxeles),")
    print("los algoritmos O(n²) tardarían mucho tiempo.")
    print("Se usará una muestra pequeña para demostración.\n")
    
    # Muestra pequeña para algoritmos lentos
    muestra_size = 10000
    ...
    # Bubble Sort (solo muestra)
    print("\n1. BUBBLE SORT (muestra)")
    ...
    print(f"   ¿Terminó? SÍ (en muestra)")
    
    # Insertion Sort (solo muestra)
    ...
    print(f"   Tiempo de ejecución: {tiempo_insertion:.4f} segundos")
    print(f"   ¿Terminó? SÍ (en muestra)")
    
    # Selection Sort (solo muestra)
    ...
    print(f"   Tiempo de ejecución: {tiempo_selection:.4f} segundos")
    print(f"   ¿Terminó? SÍ (en muestra)")
    
    # Merge Sort (imagen completa)
    print("\n4. MERGE SORT (imagen completa - algoritmo eficiente)")
    print("   Ordenando 1,440,000 elementos...")
    arr_ordenado, comp_merge, tiempo_merge = merge_sort(arreglo_1d)
